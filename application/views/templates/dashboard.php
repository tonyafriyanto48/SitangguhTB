...
<head>
    ...
    <title><?= $title; ?> | SI TANGGUH TB</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex text-white align-items-center bg-info justify-content-center" href="<?= base_url('dashboard'); ?>">
                <div class="sidebar-brand-icon">
                    <i class="fas fa-hospital"></i>
                </div>
                <div class="sidebar-brand-text mx-3">SI-TANGGUH TB</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('klinik'); ?>">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('pasien'); ?>">
            ...
            <!-- Nav Item - Dashboard -->
            <!-- <li class="nav-item">
                <a class="nav-link" href="<?= base_url('pasienkeluar'); ?>">
                    <i class="fas fa-running"></i>
                    <span>Pasien Sembuh / Keluar</span>
                </a>
            </li> -->
                ...
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span><?php
                                ...
                                ?></span>
                        <br>
                        <span> &copy; Si Tangguh TB &bull; Tony Afriyanto 2023 @universitas esa unggul</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
